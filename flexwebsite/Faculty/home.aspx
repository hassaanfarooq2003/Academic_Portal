<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home.aspx.cs" Inherits="Faculty_home" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="main-content">
                ...
                <h2>Personal Information
                    <asp:Table ID="Table1" CssClass="table-dark-header custom-table" runat="server"
                        Height="18px" Width="548px" style="margin-top: 15px">
                        <asp:TableRow>

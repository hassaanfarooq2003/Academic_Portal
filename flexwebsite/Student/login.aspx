<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="studentlogin" StyleSheetTheme=""
    %>
...
.header {
    ...
    position: relative;
            ...
            .auto-style1 {
                /* Reduce the min-height to adjust the size of the header. */
            min-height: 80vh; /* Adjust this value as needed. */;
                width: 100%; /* Replace pic.jpg with your actual image URL. */;
                background-image: url('linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)),url(pic.jpg)');
                background-position: center;
                background-size: cover;
                position: relative;
                left: 0px;
...
<form id="form1" runat="server">
    ...
    <div class="sign-up-form">
        ...
        <input id="input_username" type="text" class="input-box" runat="server">
        <label for="input_password" class="input-box">Password</label>
        <input id="input_password" type="password" class="input-box" runat="server">
        <p><span><input id="terms_checkbox" type="checkbox" runat="server"></span>I agree to the terms of services</p>
        <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
                <div class="login100-form-bgbtn"></div>
                <button id="customLoginBtn" class="login100-form-btn" type="submit" runat="server" onserverclick="customLoginBtn_Click">
                    Login
                </button>
            </div>
        </div>

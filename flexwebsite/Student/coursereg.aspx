<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coursereg.aspx.cs" Inherits="Student_coursereg" %>
                ...
                <main>
                    <div class="form-container">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            DataKeyNames="SECTION_ID" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ...
                            SelectCommand="SELECT [SECTION_ID], [OFFERED_COURSE_CODE] FROM [SECTIONS]">
                        </asp:SqlDataSource>
